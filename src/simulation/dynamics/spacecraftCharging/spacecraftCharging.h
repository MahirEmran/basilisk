...
public:
    ...
    Message<CurrentMsgPayload> servicerPECurrentOutMsg;  //!< Servicer photoelectric current output message
    Message<CurrentMsgPayload> targetPECurrentOutMsg;  //!< Target photoelectric current output message
...
private:
    ...
    double servicerPECurrent{};  //!< [Amps] Servicer photoelectric current
    double targetPECurrent{};  //!< [Amps] Target photoelectric current
